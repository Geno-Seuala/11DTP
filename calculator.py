...
start = int(
    input('Welcome to Geno\'s calculator V2! Please enter \"1\" to proceed: '))
if start == 1:
    valuecount = int(
        input('Great! How many values will you use in your equation? (2 or 3): '))
...
# prompts the user to input an operation and two values
    ...
    if valuecount == 2:
        ...
        operation = int(input(
            'Now enter the ID of which operation you wish to use! (1-Addition, 2-Subtraction, 3-Multiplication, 4-Division): '))
...
# prompts the user to input two operations and three values
        ...
        operation1 = int(input(
            'Now enter the ID of which operation you wish to use first! (1-Addition, 2-Subtraction, 3-Multiplication, 4-Division): '))
        value2 = int(input('Now please enter your second value: '))
        operation2 = int(input(
            'Now enter the ID of which operation you wish to use second! (1-Addition, 2-Subtraction, 3-Multiplication, 4-Division): '))
